...
# Dado una lista de strings genera un diccionario donde las claves son tuplas de dos palabras consecutivas en cada string
    ...
    if palabra_posterior:
        for i in frecuencias:
            if i[1] == palabra_posterior:
                if candidatas[i[0]]: 
                    candidatas[i[0]] += frecuencias[i] * 10
                else:
